...
<?php if (!isset($SESSION['user_data'])){
    ...
    <title>Stock Management - Register Supplier</title>
...
<body class="loginRegister">
    <div class="border col-md-4 d-flex flex-column position-relative   bg-white my-auto border-primary rounded-3 mx-auto mt-3" style="height:760px">
        <h5 class="w-50 mx-auto describer text-white mt-4">Create Supplier</h5>
        ...
        <form method="POST" name="createUser" enctype="multipart/form-data" style="height:80%;" class="col-md-12" action="<?php echo base_url() ?>Stock/createSupplier/<?php echo $user['user_id'];?>">
            ...
            <div class="form-part">
                ...
                <input required type="tel"  name="telephone" class="form-input" />
              <p class="fs-6 text-danger">  <?php echo form_error('telephone'); ?></p>

            </div>
            <div class="form-part">
                <Label>Location</Label>
                <input required type="text"  name="location" class="form-input" />
              <p class="fs-6 text-danger">  <?php echo form_error('location'); ?></p>
