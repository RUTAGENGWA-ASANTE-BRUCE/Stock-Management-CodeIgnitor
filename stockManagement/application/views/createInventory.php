...
<?php if (!isset($SESSION['user_data'])){
    ...
    <title>Stock Management - Create Inventory</title>
...
<body class="loginRegister">
    <div class="border col-md-4 d-flex flex-column position-relative   bg-white my-auto border-primary rounded-3 mx-auto mt-3" style="height:760px">
        <h5 class="w-50 mx-auto describer text-white mt-4">Create Inventory</h5>
        ...
        <div class="form-part d-flex flex-column">
                    ...
                    <select name="product">
                        ...
                        if(!empty($products)){
                            foreach($products as $product){
                                ?>
                                <option value="<?php echo $product['name'].','.$product['product_id'].','.$product['productImage'].','.$product['price'].','.$product['supplierName'].','.$product['supplierId'];?>"><?php echo $product['name'];?></option>
                                <?php
                            }
                        }
                      ?>
            ...
            <div class="form-part">
                <Label>Amount</Label>
                <input required type="number" name="amount" class="form-input" />
            </div>
            <div class="form-part d-flex flex-column">
                <p>Color</p>
                <div class="d-flex justify-content-between">
                    <div class="d-flex">
                        ...
                        <input type="radio" name="color" class="me-2 mt-2" value="red" checked> Red
                    </div>
                    <div class="d-flex">

                        <input type="radio" name="color" class="me-2 mt-2" value="black" checked> Black
                    </div>
                    <div class="d-flex">

                        <input type="radio" name="color" class="me-2 mt-2" value="green"> Green
                    </div>
                    <div class="d-flex">
                        <input type="radio" name="color" class="me-2 mt-2" value="Yellow"> Yellow
