                    ...
                    <?php if (!empty($inventories)) {
                        foreach ($inventories as $inventory) { ?>
                            <tr class="bg-white"  style="height:80px;">
                                ...
                                <td><img src="<?php echo base_url() . '/public/images/' . $inventory['productImage']; ?>" style="width:80px; height:60px; border-radius:10px;" /></td>
                                <td>
                                    <div style="background-color:<?php echo $inventory['color']; ?>;width:20px;height: 20px;border-radius:50%;margin-left: 3px;"></div>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <form method="post" action="<?php echo base_url() . 'Stock/editInventory/' . $inventory['inventory_id'] ?>"><button class="btn btn-primary">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                                Edit</button>
                                            <input type="hidden" name="user_id" value="<?php echo $user['user_id']; ?>">
                                        </form>

                                        <form action="<?php echo base_url() . 'Stock/deleteInventory/' . $inventory['inventory_id'] ?>" method="post">
